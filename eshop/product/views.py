...
from .models import ProductImages,Product,Review
from rest_framework.permissions import IsAuthenticated,IsAdminUser
from rest_framework.response import Response
from .serializers import ProductImagesSerializer,ProductSerializer,ProductImages
...
def update_product(request,pk):
    ...
    product.ratings = request.data['rating']
